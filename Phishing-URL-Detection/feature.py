...
class FeatureExtraction:
    ...
    def __init__(self,url):
        ...
        # Trusted Domain Intelligence (Reduce False Positives for Banks)
        self.is_trusted = False
        trusted_keywords = ['sbi.co.in', 'onlinesbi.sbi', 'onlinesbi.com', 'hdfcbank.com', 'icicibank.com', 'axisbank.com']
        if any(keyword in self.domain.lower() for keyword in trusted_keywords):
